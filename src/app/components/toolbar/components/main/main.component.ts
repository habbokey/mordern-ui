...
import { DesktopViewComposer, Dispose, DropBounce, EaseOut, FollowFriendMessageComposer, JumpBy, Motions, Nitro, NitroToolbarAnimateIconEvent, NitroToolbarEvent, Queue, ToolbarIconEnum, Wait } from '@nitrots/nitro-renderer';
...
export class ToolbarMainComponent implements OnInit, OnDestroy
{
    ...
    {
        Nitro.instance.communication.connection.send(new FollowFriendMessageComposer(id));
    }
